# My Custom Plugin- Frontend Code

This directory contains the frontend code for the My Custom Plugin plugin.
...
This will compile the frontend into the `../inventree_explosives/static` directory (ready for distribution).
